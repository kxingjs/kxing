...
export class Fnc1FirstPositionMode extends Mode {
    ...
    constructor() {
        super(Fnc1FirstPositionMode.CHARACTER_COUNT_BITS, Fnc1FirstPositionMode.BITS);
    }
}
export class Fnc1SecondPositionMode extends Mode {
    ...
    constructor() {
        super(Fnc1SecondPositionMode.CHARACTER_COUNT_BITS, Fnc1SecondPositionMode.BITS);
    }
}
