...
export default class QRDecoder {
    private decoder: ReedSolomonDecoder = new ReedSolomonDecoder(GenericGF.QR_CODE_FIELD_256);
    ...
    public decode(bits: BitMatrix): DecoderResult {
        ...
        const ecLevel = bitMatrixParser.readFormatInformation().errorCorrectionLevel;
