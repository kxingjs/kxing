...
describe("FormatInformation", function () {
    ...
    describe("basic decode", function () {
        ...
        const expected: FormatInformation = FormatInformation.decodeFormatInformation(MASKED_TEST_FORMAT_INFO, MASKED_TEST_FORMAT_INFO);
        ...
        it("should be idempotent", function () {
            expect(expected).to.eql(FormatInformation.decodeFormatInformation(UNMASKED_TEST_FORMAT_INFO, MASKED_TEST_FORMAT_INFO));
        });
    });
    ...
    describe("decode with fomat information mask.", function () {
        ...
        it("should be idempotent", function () {
            expect(expected).to.eql(FormatInformation.decodeFormatInformation(MASKED_TEST_FORMAT_INFO ^ 0x03, MASKED_TEST_FORMAT_INFO ^ 0x0F));
        })
    });
});
